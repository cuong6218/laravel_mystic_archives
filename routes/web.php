...
Route::group(['middleware' => ['get.menu']], function () {
    ...
    Route::resource('resource/{tables}/resource', 'ResourceController')->names([
    ...
    Route::group(['middleware' => ['role:admin']], function () {
        ...
        Route::prefix('grades')->group(function () {
            ...
            Route::get('/add', 'GradeController@create')->name('grades.create');
            Route::post('/add', 'GradeController@store')->name('grades.store');
            Route::get('/{id}/update', 'GradeController@edit')->name('grades.edit');
            Route::post('/{id}/update', 'GradeController@update')->name('grades.update');
            Route::get('/{id}/delete', 'GradeController@destroy')->name('grades.delete');
        });
        Route::prefix('kids')->group(function () {
            Route::get('/', 'KidController@index')->name('kids.index');
            Route::get('/add', 'KidController@create')->name('kids.create');
            Route::post('/add', 'KidController@store')->name('kids.store');
            Route::get('/{id}/update', 'KidController@edit')->name('kids.edit');
            Route::post('/{id}/update', 'KidController@update')->name('kids.update');
            Route::get('/{id}/delete', 'KidController@destroy')->name('kids.delete');
        });
        Route::prefix('types')->group(function () {
            Route::get('/', 'TypeController@index')->name('types.index');
            Route::get('/add', 'TypeController@create')->name('types.create');
            Route::post('/add', 'TypeController@store')->name('types.store');
            Route::get('/{id}/update', 'TypeController@edit')->name('types.edit');
            Route::post('/{id}/update', 'TypeController@update')->name('types.update');
            Route::get('/{id}/delete', 'TypeController@destroy')->name('types.delete');
        });
        Route::prefix('books')->group(function () {
            Route::get('/', 'BookController@index')->name('books.index');
            Route::get('/add', 'BookController@create')->name('books.create');
            Route::post('/add', 'BookController@store')->name('books.store');
