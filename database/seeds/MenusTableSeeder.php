...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        $this->insertLink('admin', 'Books',                   '/books', 'cil-book');
        $this->insertLink('admin', 'Types',                   '/types', 'cil-color-palette');
        $this->insertLink('admin', 'Grades',                   '/grades', 'cil-school');
        $this->insertLink('admin', 'Kids',                   '/kids','cil-animal');
