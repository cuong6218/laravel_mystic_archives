...
class BreadTest extends TestCase
{
    ...
    public function testStore(){
        ...
        $response->assertStatus(200);
        $response->assertSee('Table not detected, or there is no columns in tables');
    }
    ...
    public function testStore2(){
        ...
        $response->assertSee('Records on one page of tables');
        foreach($columns as $column){
    ...
    public function testShow(){
        ...
        $response->assertSee('Form name');
        $response->assertSee('Database tables name');
        $response->assertSee('Records on one page of tables');
    }
